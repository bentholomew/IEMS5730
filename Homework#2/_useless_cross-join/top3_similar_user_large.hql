...
LOAD DATA INPATH './movielens_large' INTO TABLE movielens_large;
...
FROM (SELECT  
    ...
    FROM movielens_large AS data1
    CROSS JOIN movielens_large AS data2
